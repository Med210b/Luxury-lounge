...
export const ImperialKeycard3D: React.FC = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('WebGL unavailable in ImperialKeycard3D, using CSS card:', err);
    ...
    if (ctx) {
      // Midnight Obsidian Imperial Velvet Gradient
      const bgGrad = ctx.createLinearGradient(0, 0, 1024, 640);
      bgGrad.addColorStop(0, '#0F1522');
      bgGrad.addColorStop(0.25, '#070B13');
      bgGrad.addColorStop(0.55, '#131B2C');
      bgGrad.addColorStop(0.8, '#080D17');
      bgGrad.addColorStop(1, '#030509');
      ctx.fillStyle = bgGrad;
      ctx.fillRect(0, 0, 1024, 640);

      // Geometric Guilloche / Diamond Imperial Lattice in Crisp Silver
      ...
      // Outer Dual Metallic Frame (Polished Silver & Fine Specular Trim)
      ...
      ctx.fillText('ULTRA-PRIVATE & FAMILY OFFICE • GLOBAL', 75, 142);
      ...
      if (ctx.roundRect) {
        ctx.roundRect(75, 205, 110, 85, 8);
      } else {
        ctx.fillRect(75, 205, 110, 85);
      }
      ctx.fill();
      ...
      // Contactless Wave in Radiant Silver
      ...
      ctx.fillText('IMPERIAL', 75, 425);

      // Role
      ctx.fillStyle = '#CBD5E1';
      ctx.font = '600 22px "Plus Jakarta Sans", sans-serif';
      ctx.fillText('ROLE: ULTRA-PRIVATE BESPOKE CONCIERGE', 75, 480);

      // Member ID & Expiry
      ctx.font = '500 17px monospace';
      ctx.fillStyle = '#E2E8F0';
      ctx.fillText('LL-IMP • 0001 / 2026', 75, 560);

      ctx.textAlign = 'right';
      ctx.font = '600 20px "Plus Jakarta Sans", sans-serif';
      ctx.fillStyle = '#F1F5F9';
      ctx.fillText('24/7 DEDICATED DESK', 945, 560);
    }
    ...
    if (bCtx) {
      ...
      bCtx.fillText('Ultra-Private Client Signature • Priority Verified', 80, 282);
      ...
      bCtx.fillText('777', 790, 282);

      // Imperial Privileges & Hotline
      bCtx.fillStyle = '#94A3B8';
      bCtx.font = '15px "Plus Jakarta Sans", sans-serif';
      bCtx.fillText('PRIORITY IMPERIAL HOTLINE: +971 4 800 IMPERIAL', 60, 370);
      bCtx.fillText('HIGHEST-PRIORITY HANDLING & EMERGENCY LAST-MINUTE DISPATCH', 60, 400);
      bCtx.fillText('INTERNATIONAL CONCIERGE • PRIVATE AVIATION • BESPOKE TRAVEL', 60, 430);

      // Silver Frame on Back
    ...
    // Box Geometry: width 4.5, height 2.85, depth 0.07 matching Prestige & Signature
    ...
    // Beveled Wireframe Edge Frame matching Prestige
    ...
    // Orbiting Particles (Silver & Diamond Starlight Nebula)
    ...
    const animate = () => {
      ...
      try {
        ...
        console.warn('Imperial card render error, using CSS fallback:', renderErr);
        ...
        <div className="relative w-full max-w-[420px] aspect-[1.586/1] rounded-2xl p-6 border-2 border-white/60 bg-gradient-to-br from-[#1E293B] via-[#0F172A] to-[#020617] shadow-[0_20px_50px_rgba(0,0,0,0.9),0_0_30px_rgba(255,255,255,0.15)] flex flex-col justify-between transition-transform duration-300 hover:scale-[1.03]">
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="text-[#94A3B8] font-mono text-[9px] tracking-widest uppercase">SOVEREIGN PATRONAGE • ZURICH &amp; DUBAI</div>
            </div>
          ...
          <div className="my-auto py-2">
            <div className="text-2xl sm:text-3xl font-serif font-bold text-white tracking-[0.25em] uppercase luxury-silver-animated-text luxury-silver-imperial">
              IMPERIAL
            </div>
            <div className="text-[10px] font-mono text-[#CBD5E1] tracking-widest uppercase mt-1">
              SOVEREIGN DIPLOMATIC KEYCARD • NO. 0007-GLB
            </div>
          </div>
          <div className="flex items-end justify-between border-t border-white/15 pt-3">
            <div>
              ...
              <div className="text-xs font-mono text-white font-medium tracking-widest">IMPERIAL PATRON</div>
            </div>
            <div className="text-right">
              <div className="text-[9px] font-mono text-[#94A3B8] uppercase">VALID WORLDWIDE</div>
              <div className="text-[10px] font-mono text-[#E2E8F0] tracking-widest">DIPLOMATIC ALPHA 1</div>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between w-full pointer-events-none">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] sm:text-[11px] font-mono uppercase tracking-[0.16em] sm:tracking-[0.25em] text-[#F1F5F9]">
            Interactive 3D Imperial Keycard
          </span>
        </div>
      ...
      <div
        ...
        title="Swipe or drag to rotate 3D Imperial Keycard • Move cursor to inspect specular silver sheen"
      />
